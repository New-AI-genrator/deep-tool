            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="border-t border-white/10 p-4 bg-gray-800/50 backdrop-blur-xl">
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    <input
                      ...
                      className="w-full px-4 py-3 pl-12 bg-gray-700/50 border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 transition-all"
                ...
                <p className="text-xs text-gray-400 mt-2 text-center">
                  {isListening ? "Listening... Speak now" : "Ask me about tools, categories, features, or pricing"}
                </p>
              </form>
            </>
          )}
