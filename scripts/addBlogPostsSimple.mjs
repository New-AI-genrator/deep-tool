...
// Remove the first comma and add a comma at the end
newBlogPostsString = newBlogPostsString.substring(2) + ',';

// Insert the new blog posts before the closing bracket
const beforeInsert = fileContent.substring(0, insertPosition + 3);
const afterInsert = fileContent.substring(insertPosition + 3);

const updatedContent = beforeInsert + newBlogPostsString + afterInsert;
